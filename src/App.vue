...
<template>
	<div>
		<!--1.0 利用mint-ui 中的header组件实现整个系统的头部-->
		<mt-header clearfixed title="VUE商城"></mt-header>
		
		<!-- 2.0 利用vue-router的 <router-link>进行占位-->
		<router-view></router-view>

		<!-- 3.0 利用mui中tabbar组件实现系统的底部-->
		<nav class="mui-bar mui-tmpl mui-bar-tab">
